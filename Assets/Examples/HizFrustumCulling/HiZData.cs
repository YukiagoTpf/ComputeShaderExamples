...
public class HizMap
{
    ...
    public void Update(ScriptableRenderContext context, Camera camera,RTHandle depthRTHandle)
    {
        ...
        m_CommandBuffer.SetComputeTextureParam(m_ComputerShader, KERNEL_BLIT, ShaderConstants.InTex, depthRTHandle);
